...
<div class="admin-button-grid">
    ...
    <a href="${pageContext.request.contextPath}/admin/categories" class="admin-button" style="background-color:#6f42c1;"><i class="fas fa-tags me-2"></i> Категории</a>
    <a href="${pageContext.request.contextPath}/admin/order-statuses" class="admin-button" style="background-color:#fd7e14;"><i class="fas fa-clipboard-check me-2"></i> Статусы заказов</a>
